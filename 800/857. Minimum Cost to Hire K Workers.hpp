...
// wage/quality ratio is const in the paid group
// Every worker has an expected ratio of wage compared to his quality.
// In a paid group, we'll have to pay with largest expected ratio
...
public:
    double mincostToHireWorkers(vector<int> q, vector<int> w, int K) {
        ...
        double res = std::numeric_limits<double>::max(), qsum = 0;
